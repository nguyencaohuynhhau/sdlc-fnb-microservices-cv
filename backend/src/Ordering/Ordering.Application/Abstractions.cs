...
public interface IOrderRepository
{
    ...
    /// <summary>Đơn của một ca (chỉ đọc). <paramref name="newestFirst"/>: POS xem mới nhất trước, bếp làm cũ nhất trước.</summary>
    Task<IReadOnlyList<Order>> ListByShiftAsync(Guid shiftId, OrderStatus? status, bool newestFirst, CancellationToken ct);
